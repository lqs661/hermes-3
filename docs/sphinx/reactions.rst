...
These rates are intended to use ADAS (96) files in the same way as carbon and neon:
SCD and PLT for ionisation and radiation loss; ACD and PRB for recombination and
radiation loss; and CCD for charge exchange coupling to hydrogen isotopes.

+----------------------+-------------------------------------+
| Reaction             | Description                         |
+======================+=====================================+
| b + e -> b+ + 2e     | Boron ionisation                    |
+----------------------+-------------------------------------+
| b+ + e -> b+2 + 2e   |                                     |
+----------------------+-------------------------------------+
| b+2 + e -> b+3 + 2e  |                                     |
...
| b+5 + e -> b+4       |                                     |
+----------------------+-------------------------------------+
| b+ + h -> b + h+     | Charge exchange with hydrogen       |
+----------------------+-------------------------------------+
| b+2 + h -> b+ + h+   |                                     |
+----------------------+-------------------------------------+
| b+3 + h -> b+2 + h+  |                                     |
...
| b+5 + h -> b+4 + h+  |                                     |
+----------------------+-------------------------------------+
| b+ + d -> b + d+     | Charge exchange with deuterium      |
+----------------------+-------------------------------------+
| b+2 + d -> b+ + d+   |                                     |
+----------------------+-------------------------------------+
| b+3 + d -> b+2 + d+  |                                     |
...
| b+5 + d -> b+4 + d+  |                                     |
+----------------------+-------------------------------------+
| b+ + t -> b + t+     | Charge exchange with tritium        |
+----------------------+-------------------------------------+
| b+2 + t -> b+ + t+   |                                     |
+----------------------+-------------------------------------+
| b+3 + t -> b+2 + t+  |                                     |
...
The implementation of these rates is in ``ADASBoronIonisation``,
``ADASBoronRecombination`` and ``ADASBoronCX`` template classes:

.. doxygenstruct:: ADASBoronIonisation
   :members:

.. doxygenstruct:: ADASBoronRecombination
   :members:

.. doxygenstruct:: ADASBoronCX
   :members:
